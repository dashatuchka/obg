...
let scenario = {
    ...
    three: {
        ...
        buttons: [["Нет, потому что другу больше 12 лет", "moveNextStep(scenario.four)"], ["Да, нужно, так как пассажири до 18 лет должны сидеть на специальном кресле", "moveNextStep(scenario.eleven)"]]
    },
